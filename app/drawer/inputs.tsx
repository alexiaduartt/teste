...
const InputListItem = ({ input }: { input: any }) => {
  ...
  const onPressDetails = () => {
    router.push({
      pathname: '/details/[id]',
      params: { id: input.id, type: 'Insumo' } 
    });
  };
  ...
  return (
    <View style={[styles.listItem, { backgroundColor: themeColors.detailBackground }]}>
      <View style={styles.listItemContent}>
        <Text style={[styles.listItemText, { color: themeColors.detailLabel, fontWeight: 'bold' }]}>{input.name}</Text>
        <Text style={[styles.listItemText, { color: themeColors.detailLabel }]}>Tipo: {input.type} | Quantidade: {input.quantity}</Text>
        <Text style={[styles.listItemText, { color: themeColors.detailLabel }]}>Fornecedor: {input.supplier}</Text>
      </View>
  ...
  return (
    <SafeAreaView style={[styles.safeArea, { backgroundColor: themeColors.primary }]}>
      ...
      <View style={[styles.container, { backgroundColor: themeColors.background }]}>
        <Text style={[styles.pageTitle, { color: themeColors.primary }]}>Gestão de Insumos</Text>
      ...
      <BottomNavButton title="+ Cadastrar Insumo" onPress={navigateToInputRegistration} />
    </SafeAreaView>
  );
}
