  ...
  return (
    <SafeAreaView style={[styles.safeArea, { backgroundColor: themeColors.primary }]}>
      ...
      <View style={[styles.container, { backgroundColor: themeColors.background }]}>
        <Text style={[styles.pageTitle, { color: themeColors.primary }]}>Cadastrar Produto</Text>
        ...
        <ScrollView style={styles.formContainer} contentContainerStyle={styles.formContent}>
          <View style={[styles.inputGroup, { backgroundColor: themeColors.detailBackground }]}>
            ...
            <View style={styles.row}>
              <LabelledInput label="CATEGORIA" required containerStyle={styles.halfInput} />
              <LabelledInput label="PREÇO UNITÁRIO" required keyboardType="numeric" containerStyle={styles.halfInput} />
            </View>

            <View style={styles.row}>
              <LabelledInput label="STATUS" required containerStyle={styles.halfInput} />
              <LabelledInput label="QUANTIDADE" required keyboardType="numeric" containerStyle={styles.halfInput} />
            </View>
            
            <LabelledInput label="FORNECEDOR" required />
            <LabelledInput label="LOCAL DE ARMAZENAMENTO" required />
            <LabelledInput label="DATA DE VALIDADE" required placeholder="DD/MM/AAAA" />
            <LabelledInput label="Descrição" multiline numberOfLines={4} style={{ height: 100 }} />
          ...
          <View style={{ height: 100 }} /> {/* Espaço extra para scroll */}
        </ScrollView>
      </View>
